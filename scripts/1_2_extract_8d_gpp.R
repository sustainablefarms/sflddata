...
writeRaster(gpp_brick_sept, filename = "./private/data/remote_sensed/gpp_Sept6th.grd")

# average gpp across time dimension only:
gpp_8d_tmn_ras <- mean(gpp_8d_sws_brick)
writeRaster(gpp_8d_tmn_ras, filename = "./private/data/remote_sensed/gpp_mean.grd")
...
writeRaster(difftotmn[[grep("X.....09.06", names(difftotmn))]],
            filename = "./private/data/remote_sensed/gpp_diff_to_mean_Sept6th.grd")

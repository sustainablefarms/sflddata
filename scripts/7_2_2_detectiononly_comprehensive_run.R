...
Xobs <- model.matrix(as.formula("~ MeanWind * MeanTime * MeanClouds * MeanTemp - 1"), data = inputdata$plotsmerged_detection)
Xobs <- scale(Xobs)
...
saveRDS(fit.runjags, "./tmpdata/7_2_2_detectiononly_comprehensive_run_20200529.rds") 

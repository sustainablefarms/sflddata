...
The exception, is the Australian Reed-Warbler, which is a passeriformes. It is observed quite a lot in our data, I wonder why it was specifically removed in first start of this project.

```{r easterngreategret_observed}
nrow(birds_renamed[birds_renamed$CommonName == "Australian Reed-Warbler", ])
```

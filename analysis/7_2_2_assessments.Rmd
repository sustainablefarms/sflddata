...
fittedmods <-list(
wind = readRDS("./tmpdata/deto_wind.rds"),
wind_June4 = readRDS("./tmpdata/deto_wind_June4.rds"),
time = readRDS("./tmpdata/deto_time.rds"),
windtemp = readRDS("./tmpdata/deto_windtemp.rds"),
windtime = readRDS("./tmpdata/deto_windtime.rds"),
windtemp_time = readRDS("./tmpdata/deto_windtemp_time.rds"),
windtimeclouds_temp = readRDS("./tmpdata/windtimeclouds_temp_June4.rds"),
windtimecloudstemp = readRDS("./tmpdata/windtimecloudstema_June4.rds")
)
...
+ Include MeanWind^2?
+ Include MeanTime^2? *this could be checked by plotting residuals again MeanTime*
+ A model of MeanWind^2 + MeanTime^2 + MeanClouds^2 + MeanTemp^2 could work?
+ __Can these plots be used to guess whether to include interaction terms of new variables?__
  + If the interaction term *should* be included then it contributes to the model differently to either covariate individually. I would expect the shape of the residuals against both (a 3D plot) to be different to the marginals.
  + Plot the residual against covar1 for various bins of covar2.

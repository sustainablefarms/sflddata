...
tdy_siteterms_m7 %>%
  ...
  geom_point(aes(x = longitude, y = latitude, size  = estimate / std.error, col = estimate / std.error), alpha = 0.5) +
  scale_color_viridis_c() +
...
### Future
 ...
 + Remove outliers to achieve residuals that are normally distributed (check with Q-Q plot)
 ...
 + Search for a better scale in the Box-Cox transformation using `m1`.

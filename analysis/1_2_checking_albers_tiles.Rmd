...
WThis means xmin_ymin is 21_-37, which doesn't even exist in the catalogue, and certainly doens't match the location of Syndey in the maps.
...
## Check Importing of Landcover Metrics, including Woody Cover
```{r woodycoverread}
years <- 2018:2019
...
It looks like the coordinates are flipped along the horizontal axis in the 2019 compared to 2018. This represents a reversal of the latitude coordinate.

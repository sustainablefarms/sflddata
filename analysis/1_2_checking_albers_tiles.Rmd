...
```{r arbitrarytile}
nc <- nc_open("http://dapds00.nci.org.au/thredds/dodsC/ub8/au/LandCover/DEA_ALC/0_-12/fc_metrics_0_-12_2000.nc")
...
```{r bcrs}
r <- raster("http://dapds00.nci.org.au/thredds/dodsC/ub8/au/LandCover/DEA_ALC/0_-12/fc_metrics_0_-12_2000.nc", varname = "WCF")
proj4string(r)
```
...
```{r sydtile}
bsyd <- raster("http://dapds00.nci.org.au/thredds/dodsC/ub8/au/LandCover/DEA_ALC/17_-39/fc_metrics_17_-39_2000.nc", varname = "WCF", dims = 2:1)
plot(bsyd)
...
```{r preproi}
sws_sites <- readRDS("../linking-private/data/private/data/sws_sites.rds")
...
```{r tilefiles_2000}
tilefiles2000 <- paste0("http://dapds00.nci.org.au/thredds/dodsC/ub8/au/LandCover/DEA_ALC/",
      tilesidx,
      "/fc_metrics_",
      tilesidx,
      "_2000.nc")

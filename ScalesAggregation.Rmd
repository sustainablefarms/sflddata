...
[Warton, Hui et al.](http://www.sciencedirect.com/science/article/pii/S0169534715002402) [Box 3] appear to do one of these two things. 

If species are *independent*, and that detection attempts are independent, then we can get a distribution of the number of species detected as below.
...
Suppose there is $K = 10$ species in total and the probability of detection for a unit of effort for each species is
...
row.names(p_i_t) <- t
rich_dist <- apply(p_i_t, 1, richness_dist) #takes a REAALLY long time for many species
